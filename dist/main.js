	...
	return _Utils_Tuple2(
		{
			...
			userInfo: A2($author$project$Main$UserInfo, '', '')
		},
		$elm$core$Platform$Cmd$none);
};
var $author$project$Main$RecvFCToken = function (a) {
	return {$: 'RecvFCToken', a: a};
};
...
var $author$project$Main$RecvUserInfo = function (a) {
	return {$: 'RecvUserInfo', a: a};
};
...
var $author$project$Main$getUserInfo = function (authInfo) {
	return $elm$http$Http$get(
		{
			expect: $elm$http$Http$expectString($author$project$Main$RecvUserInfo),
...
var $author$project$Main$decodeUserInfo = A3(
	$elm$json$Json$Decode$map2,
	$author$project$Main$UserInfo,
	A2($elm$json$Json$Decode$field, 'id', $elm$json$Json$Decode$string),
	A2($elm$json$Json$Decode$field, 'name', $elm$json$Json$Decode$string));
var $author$project$Main$parseUserInfo = function (info) {
	var _v0 = A2($elm$json$Json$Decode$decodeString, $author$project$Main$decodeUserInfo, info);
	if (_v0.$ === 'Err') {
		return A2($author$project$Main$UserInfo, '', '');
	} else {
		var v = _v0.a;
		return v;
	}
	...
	function (msg, model) {
		switch (msg.$) {
			...
			case 'RequestUserInfo':
				return _Utils_Tuple2(
					model,
					$author$project$Main$getUserInfo(model.facebookAuthInfo));
			default:
				var message = msg.a;
				if (message.$ === 'Ok') {
					var info = message.a;
					return _Utils_Tuple2(
						_Utils_update(
							model,
							{
								userInfo: $author$project$Main$parseUserInfo(info)
							}),
						$elm$core$Platform$Cmd$none);
				} else {
...
var $author$project$Main$RequestUserInfo = {$: 'RequestUserInfo'};
	...
	return A2(
		...
		_List_fromArray(
			[
				...
				_List_fromArray(
					[
						$elm$html$Html$text('User name ' + model.userInfo.name)
					])),
				A2(
				$elm$html$Html$button,
				_List_fromArray(
					[
						$elm$html$Html$Events$onClick($author$project$Main$RequestUserInfo)
					]),
				_List_fromArray(
					[
						$elm$html$Html$text('getUserInfo')
					]))
			]));
};
